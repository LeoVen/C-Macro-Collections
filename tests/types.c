...
COLLECTION_GENERATE(INTERVALHEAP, ih0, iheap0, static, struct_t *, struct_t *)
COLLECTION_GENERATE(MULTIMAP, mm0, mmap0, static, struct_t *, struct_t *)
COLLECTION_GENERATE(MULTISET, ms0, mset0, static, struct_t *, struct_t *)
...
COLLECTION_GENERATE(INTERVALHEAP, ih1, iheap1, static, struct_t, struct_t)
COLLECTION_GENERATE(MULTIMAP, mm1, mmap1, static, struct_t, struct_t)
COLLECTION_GENERATE(MULTISET, ms1, mset1, static, struct_t, struct_t)
...
COLLECTION_GENERATE(INTERVALHEAP, ih2, iheap2, static, /* K */, int)
COLLECTION_GENERATE(MULTIMAP, mm2, mmap2, static, int, int)
COLLECTION_GENERATE(MULTISET, ms2, mset2, static, /* K */, int)
...
COLLECTION_GENERATE(INTERVALHEAP, ih3, iheap3, static, /* K */, int *)
COLLECTION_GENERATE(MULTIMAP, mm3, mmap3, static, int *, int *)
COLLECTION_GENERATE(MULTISET, ms3, mset3, static, /* K */, int *)
...
COLLECTION_GENERATE(INTERVALHEAP, ih4, iheap4, static, /* K */, enum_t *)
COLLECTION_GENERATE(MULTIMAP, mm4, mmap4, static, enum_t *, enum_t *)
COLLECTION_GENERATE(MULTISET, ms4, mset4, static, /* K */, enum_t *)
...
COLLECTION_GENERATE(INTERVALHEAP, ih5, iheap5, static, /* K */, enum_t)
COLLECTION_GENERATE(MULTIMAP, mm5, mmap5, static, enum_t, enum_t)
COLLECTION_GENERATE(MULTISET, ms5, mset5, static, /* K */, enum_t)
...
COLLECTION_GENERATE(INTERVALHEAP, ih6, iheap6, static, /* K */, union_t *)
COLLECTION_GENERATE(MULTIMAP, mm6, mmap6, static, union_t *, union_t *)
COLLECTION_GENERATE(MULTISET, ms6, mset6, static, /* K */, union_t *)
...
COLLECTION_GENERATE(INTERVALHEAP, ih7, iheap7, static, /* K */, union_t)
COLLECTION_GENERATE(MULTIMAP, mm7, mmap7, static, union_t, union_t)
COLLECTION_GENERATE(MULTISET, ms7, mset7, static, /* K */, union_t)
...
COLLECTION_GENERATE(INTERVALHEAP, ih8, iheap8, static, /* K */, func_t)
COLLECTION_GENERATE(MULTIMAP, mm8, mmap8, static, func_t, func_t)
COLLECTION_GENERATE(MULTISET, ms8, mset8, static, /* K */, func_t)
