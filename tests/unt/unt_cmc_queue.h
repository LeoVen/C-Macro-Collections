#ifndef CMC_TESTS_UNT_CMC_QUEUE_H
#define CMC_TESTS_UNT_CMC_QUEUE_H
...
int main(void)
{
    int result = CMCQueue() + CMCQueueIter();

    printf(" +---------------------------------------------------------------+");
    printf("\n");
    printf(" | CMCQueue Suit : %-48s |\n", result == 0 ? "PASSED" : "FAILED");
    printf(" +---------------------------------------------------------------+");
    printf("\n\n\n");
...
#endif /* CMC_TESTS_UNT_CMC_QUEUE_H */
