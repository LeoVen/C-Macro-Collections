#ifndef CMC_TESTS_UNT_CMC_ASHMULTISET_H
#define CMC_TESTS_UNT_CMC_ASHMULTISET_H
...
CMC_CREATE_UNIT(CMCHashMultiSet, true, {
...
CMC_CREATE_UNIT(CMCHashMultiSetIter, true, {
...
#endif /* CMC_TESTS_UNT_CMC_ASHMULTISET_H */
