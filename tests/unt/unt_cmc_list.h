#ifndef CMC_TESTS_UNT_CMC_LIST_H
#define CMC_TESTS_UNT_CMC_LIST_H
...
CMC_CREATE_UNIT(CMCList, true, {
    ...
    CMC_CREATE_TEST(callbacks, {
        struct list *l = l_new_custom(100, l_fval, NULL, callbacks);
...
int main(void)
{
    int result = CMCList() + CMCListIter();

    printf(" +---------------------------------------------------------------+");
    printf("\n");
    printf(" | CMCList Suit : %-49s |\n", result == 0 ? "PASSED" : "FAILED");
    printf(" +---------------------------------------------------------------+");
    printf("\n\n\n");
...
#endif /* CMC_TESTS_UNT_CMC_LIST_H */
