#ifndef CMC_TESTS_UNT_CMC_INKEDLIST_H
#define CMC_TESTS_UNT_CMC_INKEDLIST_H
...
CMC_CREATE_UNIT(CMCLinkedList, true, {
    CMC_CREATE_TEST(new, {
    ...
    CMC_CREATE_TEST(flags, {
        ...
        cmc_assert_not_equals(ptr, NULL, ll);
        cmc_assert_equals(int32_t, CMC_FLAG_OK, ll_flag(ll));

        // clear
        ll->flag = CMC_FLAG_ERROR;
        ll_clear(ll);
        cmc_assert_equals(int32_t, CMC_FLAG_OK, ll_flag(ll));
        ...
        cmc_assert_equals(int32_t, CMC_FLAG_RANGE, ll_flag(ll));
        ...
        cmc_assert_equals(int32_t, CMC_FLAG_EMPTY, ll_flag(ll));
        ...
        cmc_assert_equals(int32_t, CMC_FLAG_OK, ll_flag(ll));
        cmc_assert_equals(int32_t, CMC_FLAG_OK, ll_flag(ll2));

        // equals
        ll->flag = CMC_FLAG_ERROR;
        ll2->flag = CMC_FLAG_ERROR;
        ...
        cmc_assert_equals(int32_t, CMC_FLAG_INVALID, ll_flag(ll));
        n = ll_prev_node(n);
        cmc_assert(ll_del_next(ll, n));
        cmc_assert_equals(int32_t, CMC_FLAG_OK, ll_flag(ll));
...
CMC_CREATE_UNIT(CMCLinkedListIter, true, {
...
int main(void)
{
    int result = CMCLinkedList() + CMCLinkedListIter();

    printf(" +---------------------------------------------------------------+");
    printf("\n");
    printf(" | CMCLinkedList Suit : %-43s |\n", result == 0 ? "PASSED" : "FAILED");
    printf(" +---------------------------------------------------------------+");
    printf("\n\n\n");
...
#endif /* CMC_TESTS_UNT_CMC_INKEDLIST_H */
