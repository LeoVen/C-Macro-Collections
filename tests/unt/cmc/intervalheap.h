#ifndef CMC_TESTS_UNT_CMC_NTERVALHEAP_H
#define CMC_TESTS_UNT_CMC_NTERVALHEAP_H
...
int main(void)
{
    int result = CMCIntervalHeap() + CMCIntervalHeapIter();

    printf(" +---------------------------------------------------------------+");
    printf("\n");
    printf(" | CMCIntervalHeap Suit : %-41s |\n", result == 0 ? "PASSED" : "FAILED");
    printf(" +---------------------------------------------------------------+");
    printf("\n\n\n");
...
#endif /* CMC_TESTS_UNT_CMC_NTERVALHEAP_H */
