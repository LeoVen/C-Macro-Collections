#ifndef CMC_TESTS_UNT_CMC_EAP_H
#define CMC_TESTS_UNT_CMC_EAP_H
...
CMC_CREATE_UNIT(CMCHeapIter, true, {
...
int main(void)
{
    int result = CMCHeap() + CMCHeapIter();

    printf(" +---------------------------------------------------------------+");
    printf("\n");
    printf(" | CMCHeap Suit : %-49s |\n", result == 0 ? "PASSED" : "FAILED");
    printf(" +---------------------------------------------------------------+");
    printf("\n\n\n");
