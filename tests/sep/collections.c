...
CMC_COLLECTION_GENERATE_SOURCE(     BIDIMAP, bm,   bmap,     int, int)
...
CMC_COLLECTION_GENERATE_SOURCE(INTERVALHEAP, ih,  iheap, /* K */, int)
...
CMC_COLLECTION_GENERATE_SOURCE(    MULTISET, ms,   mset, /* K */, int)
CMC_COLLECTION_GENERATE_SOURCE(       QUEUE,  q,  queue, /* K */, int)
CMC_COLLECTION_GENERATE_SOURCE(  SORTEDLIST, sl,  slist, /* K */, int)
