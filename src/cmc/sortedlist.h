 ...
 */
#define CMC_CMC_SORTEDLIST_CORE(ACCESS, FILE, PARAMS) \
    CMC_(CMC_(CMC_CMC_SORTEDLIST_CORE_, ACCESS), CMC_(_, FILE))(PARAMS)

/* PRIVATE or PUBLIC solver */
#define CMC_CMC_SORTEDLIST_CORE_PUBLIC_HEADER(PARAMS) \
    CMC_CMC_SORTEDLIST_CORE_STRUCT(PARAMS) \
    CMC_CMC_SORTEDLIST_CORE_HEADER(PARAMS)

#define CMC_CMC_SORTEDLIST_CORE_PUBLIC_SOURCE(PARAMS) CMC_CMC_SORTEDLIST_CORE_SOURCE(PARAMS)

#define CMC_CMC_SORTEDLIST_CORE_PRIVATE_HEADER(PARAMS) \
    struct CMC_PARAM_SNAME(PARAMS); \
    CMC_CMC_SORTEDLIST_CORE_HEADER(PARAMS)

#define CMC_CMC_SORTEDLIST_CORE_PRIVATE_SOURCE(PARAMS) \
    CMC_CMC_SORTEDLIST_CORE_STRUCT(PARAMS) \
    CMC_CMC_SORTEDLIST_CORE_SOURCE(PARAMS)

/* Lowest level API */
#define CMC_CMC_SORTEDLIST_CORE_STRUCT(PARAMS) \
    CMC_CMC_SORTEDLIST_CORE_STRUCT_(CMC_PARAM_PFX(PARAMS), CMC_PARAM_SNAME(PARAMS), CMC_PARAM_V(PARAMS))
 ...
 * Struct
 * ------------------------------------------------------------------------- */
#define CMC_CMC_SORTEDLIST_CORE_STRUCT_(PFX, SNAME, V) \
\
    /* List Structure */ \
    struct SNAME \
    { \
