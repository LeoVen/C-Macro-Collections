 ...
 * will print a message to stdint but will not abort the program execution.
...
#define cmc_assert(expression)                                  \
    ...
    {                                                           \
        ...
        if (!(expression))                                      \
        {                                                       \
            printf("Assertion Failed at %s:%s:%u for { %s }\n", \
...
#define cmc_assert_equals_int8_t(expected, actual)                                                       \
    ...
    {                                                                                                    \
        ...
        {                                                                                                \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected: %" PRId8 " Actual: %" PRId8 "\n", \
...
#define cmc_assert_equals_int16_t(expected, actual)                                                        \
    ...
    {                                                                                                      \
        ...
        if (expected_ != actual_)                                                                          \
        {                                                                                                  \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected: %" PRId16 " Actual: %" PRId16 "\n", \
                   __FILE__, __func__, __LINE__, str, expected_, actual_);                                 \
        }                                                                                                  \
                                                                                                           \
    } while (0)
...
#define cmc_assert_equals_int32_t(expected, actual)                                                        \
    ...
    {                                                                                                      \
        ...
        if (expected_ != actual_)                                                                          \
        {                                                                                                  \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected: %" PRId32 " Actual: %" PRId32 "\n", \
                   __FILE__, __func__, __LINE__, str, expected_, actual_);                                 \
        }                                                                                                  \
                                                                                                           \
    } while (0)
...
#define cmc_assert_equals_int64_t(expected, actual)                                                        \
    ...
    {                                                                                                      \
        ...
        if (expected_ != actual_)                                                                          \
        {                                                                                                  \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected: %" PRId64 " Actual: %" PRId64 "\n", \
                   __FILE__, __func__, __LINE__, str, expected_, actual_);                                 \
        }                                                                                                  \
                                                                                                           \
    } while (0)
...
#define cmc_assert_equals_uint8_t(expected, actual)                                                      \
    ...
    {                                                                                                    \
        ...
        if (expected_ != actual_)                                                                        \
        {                                                                                                \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected: %" PRIu8 " Actual: %" PRIu8 "\n", \
                   __FILE__, __func__, __LINE__, str, expected_, actual_);                               \
        }                                                                                                \
                                                                                                         \
    } while (0)
...
#define cmc_assert_equals_uint16_t(expected, actual)                                                       \
    ...
    {                                                                                                      \
        ...
        if (expected_ != actual_)                                                                          \
        {                                                                                                  \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected: %" PRIu16 " Actual: %" PRIu16 "\n", \
                   __FILE__, __func__, __LINE__, str, expected_, actual_);                                 \
        }                                                                                                  \
                                                                                                           \
    } while (0)
...
#define cmc_assert_equals_uint32_t(expected, actual)                                                       \
    ...
    {                                                                                                      \
        ...
        if (expected_ != actual_)                                                                          \
        {                                                                                                  \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected: %" PRIu32 " Actual: %" PRIu32 "\n", \
                   __FILE__, __func__, __LINE__, str, expected_, actual_);                                 \
        }                                                                                                  \
                                                                                                           \
    } while (0)
...
#define cmc_assert_equals_uint64_t(expected, actual)                                                       \
    ...
    {                                                                                                      \
        ...
        if (expected_ != actual_)                                                                          \
        {                                                                                                  \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected: %" PRIu64 " Actual: %" PRIu64 "\n", \
                   __FILE__, __func__, __LINE__, str, expected_, actual_);                                 \
        }                                                                                                  \
                                                                                                           \
    } while (0)
...
#define cmc_assert_equals_intmax_t(expected, actual)                                                         \
    ...
    {                                                                                                        \
        ...
        if (expected_ != actual_)                                                                            \
        {                                                                                                    \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected: %" PRIdMAX " Actual: %" PRIdMAX "\n", \
                   __FILE__, __func__, __LINE__, str, expected_, actual_);                                   \
        }                                                                                                    \
                                                                                                             \
    } while (0)
...
#define cmc_assert_equals_uintmax_t(expected, actual)                                                        \
    ...
    {                                                                                                        \
        ...
        if (expected_ != actual_)                                                                            \
        {                                                                                                    \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected: %" PRIuMAX " Actual: %" PRIuMAX "\n", \
                   __FILE__, __func__, __LINE__, str, expected_, actual_);                                   \
        }                                                                                                    \
                                                                                                             \
    } while (0)
...
#define cmc_assert_equals_float(expected, actual)                                        \
    ...
    {                                                                                    \
        ...
        if (expected_ != actual_)                                                        \
        {                                                                                \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected: %f Actual: %f\n", \
                   __FILE__, __func__, __LINE__, str, expected_, actual_);               \
        }                                                                                \
                                                                                         \
    } while (0)
...
#define cmc_assert_equals_double(expected, actual)                                         \
    ...
    {                                                                                      \
        ...
        if (expected_ != actual_)                                                          \
        {                                                                                  \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected: %lf Actual: %lf\n", \
                   __FILE__, __func__, __LINE__, str, expected_, actual_);                 \
        }                                                                                  \
                                                                                           \
    } while (0)
...
#define cmc_assert_equals_ptr(expected, actual)                                          \
    ...
    {                                                                                    \
        ...
        if (expected_ != actual_)                                                        \
        {                                                                                \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected: %p Actual: %p\n", \
                   __FILE__, __func__, __LINE__, str, expected_, actual_);               \
        }                                                                                \
                                                                                         \
    } while (0)
...
#define cmc_assert_not_equals_int8_t(not_expected, actual)                                                   \
    ...
    {                                                                                                        \
        ...
        {                                                                                                    \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected: %" PRId8 " Actual: %" PRId8 "\n", \
...
#define cmc_assert_not_equals_int16_t(not_expected, actual)                                                    \
    ...
    {                                                                                                          \
        ...
        if (not_expected_ == actual_)                                                                          \
        {                                                                                                      \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected: %" PRId16 " Actual: %" PRId16 "\n", \
                   __FILE__, __func__, __LINE__, str, not_expected_, actual_);                                 \
        }                                                                                                      \
                                                                                                               \
    } while (0)
...
#define cmc_assert_not_equals_int32_t(not_expected, actual)                                                    \
    ...
    {                                                                                                          \
        ...
        if (not_expected_ == actual_)                                                                          \
        {                                                                                                      \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected: %" PRId32 " Actual: %" PRId32 "\n", \
                   __FILE__, __func__, __LINE__, str, not_expected_, actual_);                                 \
        }                                                                                                      \
                                                                                                               \
    } while (0)
...
#define cmc_assert_not_equals_int64_t(not_expected, actual)                                                    \
    ...
    {                                                                                                          \
        ...
        if (not_expected_ == actual_)                                                                          \
        {                                                                                                      \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected: %" PRId64 " Actual: %" PRId64 "\n", \
                   __FILE__, __func__, __LINE__, str, not_expected_, actual_);                                 \
        }                                                                                                      \
                                                                                                               \
    } while (0)
...
#define cmc_assert_not_equals_uint8_t(not_expected, actual)                                                  \
    ...
    {                                                                                                        \
        ...
        if (not_expected_ == actual_)                                                                        \
        {                                                                                                    \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected: %" PRIu8 " Actual: %" PRIu8 "\n", \
                   __FILE__, __func__, __LINE__, str, not_expected_, actual_);                               \
        }                                                                                                    \
                                                                                                             \
    } while (0)
...
#define cmc_assert_not_equals_uint16_t(not_expected, actual)                                                   \
    ...
    {                                                                                                          \
        ...
        if (not_expected_ == actual_)                                                                          \
        {                                                                                                      \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected: %" PRIu16 " Actual: %" PRIu16 "\n", \
                   __FILE__, __func__, __LINE__, str, not_expected_, actual_);                                 \
        }                                                                                                      \
                                                                                                               \
    } while (0)
...
#define cmc_assert_not_equals_uint32_t(not_expected, actual)                                                   \
    ...
    {                                                                                                          \
        ...
        if (not_expected_ == actual_)                                                                          \
        {                                                                                                      \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected: %" PRIu32 " Actual: %" PRIu32 "\n", \
                   __FILE__, __func__, __LINE__, str, not_expected_, actual_);                                 \
        }                                                                                                      \
                                                                                                               \
    } while (0)
...
#define cmc_assert_not_equals_uint64_t(not_expected, actual)                                                   \
    ...
    {                                                                                                          \
        ...
        if (not_expected_ == actual_)                                                                          \
        {                                                                                                      \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected: %" PRIu64 " Actual: %" PRIu64 "\n", \
                   __FILE__, __func__, __LINE__, str, not_expected_, actual_);                                 \
        }                                                                                                      \
                                                                                                               \
    } while (0)
...
#define cmc_assert_not_equals_intmax_t(not_expected, actual)                                                     \
    ...
    {                                                                                                            \
        ...
        if (not_expected_ == actual_)                                                                            \
        {                                                                                                        \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected: %" PRIdMAX " Actual: %" PRIdMAX "\n", \
                   __FILE__, __func__, __LINE__, str, not_expected_, actual_);                                   \
        }                                                                                                        \
                                                                                                                 \
    } while (0)
...
#define cmc_assert_not_equals_uintmax_t(not_expected, actual)                                                    \
    ...
    {                                                                                                            \
        ...
        if (not_expected_ == actual_)                                                                            \
        {                                                                                                        \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected: %" PRIuMAX " Actual: %" PRIuMAX "\n", \
                   __FILE__, __func__, __LINE__, str, not_expected_, actual_);                                   \
        }                                                                                                        \
                                                                                                                 \
    } while (0)
...
#define cmc_assert_not_equals_float(not_expected, actual)                                    \
    ...
    {                                                                                        \
        ...
        if (not_expected_ == actual_)                                                        \
        {                                                                                    \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected: %f Actual: %f\n", \
                   __FILE__, __func__, __LINE__, str, not_expected_, actual_);               \
        }                                                                                    \
                                                                                             \
    } while (0)
...
#define cmc_assert_not_equals_double(not_expected, actual)                                     \
    ...
    {                                                                                          \
        ...
        if (not_expected_ == actual_)                                                          \
        {                                                                                      \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected: %lf Actual: %lf\n", \
                   __FILE__, __func__, __LINE__, str, not_expected_, actual_);                 \
        }                                                                                      \
                                                                                               \
    } while (0)
...
#define cmc_assert_not_equals_ptr(not_expected, actual)                                      \
    ...
    {                                                                                        \
        ...
        if (not_expected_ == actual_)                                                        \
        {                                                                                    \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected: %p Actual: %p\n", \
                   __FILE__, __func__, __LINE__, str, not_expected_, actual_);               \
        }                                                                                    \
                                                                                             \
    } while (0)
...
#define cmc_assert_in_range_int8_t(lower_bound, upper_bound, actual)                                                         \
    ...
    {                                                                                                                        \
        ...
        {                                                                                                                    \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected Range: [%" PRId8 ", %" PRId8 "] Actual: %" PRId8 "\n", \
...
#define cmc_assert_in_range_int16_t(lower_bound, upper_bound, actual)                                                           \
    ...
    {                                                                                                                           \
        ...
        if (actual < lower_bound_ || actual > upper_bound_)                                                                     \
        {                                                                                                                       \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected Range: [%" PRId16 ", %" PRId16 "] Actual: %" PRId16 "\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);                                     \
        }                                                                                                                       \
                                                                                                                                \
    } while (0)
...
#define cmc_assert_in_range_int32_t(lower_bound, upper_bound, actual)                                                           \
    ...
    {                                                                                                                           \
        ...
        if (actual < lower_bound_ || actual > upper_bound_)                                                                     \
        {                                                                                                                       \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected Range: [%" PRId32 ", %" PRId32 "] Actual: %" PRId32 "\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);                                     \
        }                                                                                                                       \
                                                                                                                                \
    } while (0)
...
#define cmc_assert_in_range_uint8_t(lower_bound, upper_bound, actual)                                                        \
    ...
    {                                                                                                                        \
        ...
        if (actual < lower_bound_ || actual > upper_bound_)                                                                  \
        {                                                                                                                    \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected Range: [%" PRIu8 ", %" PRIu8 "] Actual: %" PRIu8 "\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);                                  \
        }                                                                                                                    \
                                                                                                                             \
    } while (0)
...
#define cmc_assert_in_range_uint16_t(lower_bound, upper_bound, actual)                                                          \
    ...
    {                                                                                                                           \
        ...
        if (actual < lower_bound_ || actual > upper_bound_)                                                                     \
        {                                                                                                                       \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected Range: [%" PRIu16 ", %" PRIu16 "] Actual: %" PRIu16 "\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);                                     \
        }                                                                                                                       \
                                                                                                                                \
    } while (0)
...
#define cmc_assert_in_range_uint32_t(lower_bound, upper_bound, actual)                                                          \
    ...
    {                                                                                                                           \
        ...
        if (actual < lower_bound_ || actual > upper_bound_)                                                                     \
        {                                                                                                                       \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected Range: [%" PRIu32 ", %" PRIu32 "] Actual: %" PRIu32 "\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);                                     \
        }                                                                                                                       \
                                                                                                                                \
    } while (0)
...
#define cmc_assert_in_range_uint64_t(lower_bound, upper_bound, actual)                                                          \
    ...
    {                                                                                                                           \
        ...
        if (actual < lower_bound_ || actual > upper_bound_)                                                                     \
        {                                                                                                                       \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected Range: [%" PRIu64 ", %" PRIu64 "] Actual: %" PRIu64 "\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);                                     \
        }                                                                                                                       \
                                                                                                                                \
    } while (0)
...
#define cmc_assert_in_range_intmax_t(lower_bound, upper_bound, actual)                                                             \
    ...
    {                                                                                                                              \
        ...
        if (actual < lower_bound_ || actual > upper_bound_)                                                                        \
        {                                                                                                                          \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected Range: [%" PRIdMAX ", %" PRIdMAX "] Actual: %" PRIdMAX "\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);                                        \
        }                                                                                                                          \
                                                                                                                                   \
    } while (0)
...
#define cmc_assert_in_range_uintmax_t(lower_bound, upper_bound, actual)                                                            \
    ...
    {                                                                                                                              \
        ...
        if (actual < lower_bound_ || actual > upper_bound_)                                                                        \
        {                                                                                                                          \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected Range: [%" PRIuMAX ", %" PRIuMAX "] Actual: %" PRIuMAX "\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);                                        \
        }                                                                                                                          \
                                                                                                                                   \
    } while (0)
...
#define cmc_assert_in_range_float(lower_bound, upper_bound, actual)                                  \
    ...
    {                                                                                                \
        ...
        if (actual < lower_bound_ || actual > upper_bound_)                                          \
        {                                                                                            \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected Range: [%f, %f] Actual: %f\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);          \
        }                                                                                            \
                                                                                                     \
    } while (0)
...
#define cmc_assert_in_range_double(lower_bound, upper_bound, actual)                                    \
    ...
    {                                                                                                   \
        ...
        if (actual < lower_bound_ || actual > upper_bound_)                                             \
        {                                                                                               \
            printf("Assertion Failed at %s:%s:%u for { %s }: Expected Range: [%lf, %lf] Actual: %lf\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);             \
        }                                                                                               \
                                                                                                        \
    } while (0)
...
#define cmc_assert_not_in_range_int8_t(lower_bound, upper_bound, actual)                                                         \
    ...
    {                                                                                                                            \
        ...
        {                                                                                                                        \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected Range: [%" PRId8 ", %" PRId8 "] Actual: %" PRId8 "\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);                                      \
        }                                                                                                                        \
                                                                                                                                 \
    } while (0)
...
#define cmc_assert_not_in_range_int16_t(lower_bound, upper_bound, actual)                                                           \
    ...
    {                                                                                                                               \
        ...
        if (actual >= lower_bound && actual <= upper_bound)                                                                         \
        {                                                                                                                           \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected Range: [%" PRId16 ", %" PRId16 "] Actual: %" PRId16 "\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);                                         \
        }                                                                                                                           \
                                                                                                                                    \
    } while (0)
...
#define cmc_assert_not_in_range_int32_t(lower_bound, upper_bound, actual)                                                           \
    ...
    {                                                                                                                               \
        ...
        if (actual >= lower_bound && actual <= upper_bound)                                                                         \
        {                                                                                                                           \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected Range: [%" PRId32 ", %" PRId32 "] Actual: %" PRId32 "\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);                                         \
        }                                                                                                                           \
                                                                                                                                    \
    } while (0)
...
#define cmc_assert_not_in_range_uint8_t(lower_bound, upper_bound, actual)                                                        \
    ...
    {                                                                                                                            \
        ...
        if (actual >= lower_bound && actual <= upper_bound)                                                                      \
        {                                                                                                                        \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected Range: [%" PRIu8 ", %" PRIu8 "] Actual: %" PRIu8 "\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);                                      \
        }                                                                                                                        \
                                                                                                                                 \
    } while (0)
...
#define cmc_assert_not_in_range_uint16_t(lower_bound, upper_bound, actual)                                                          \
    ...
    {                                                                                                                               \
        ...
        if (actual >= lower_bound && actual <= upper_bound)                                                                         \
        {                                                                                                                           \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected Range: [%" PRIu16 ", %" PRIu16 "] Actual: %" PRIu16 "\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);                                         \
        }                                                                                                                           \
                                                                                                                                    \
    } while (0)
...
#define cmc_assert_not_in_range_uint32_t(lower_bound, upper_bound, actual)                                                          \
    ...
    {                                                                                                                               \
        ...
        if (actual >= lower_bound && actual <= upper_bound)                                                                         \
        {                                                                                                                           \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected Range: [%" PRIu32 ", %" PRIu32 "] Actual: %" PRIu32 "\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);                                         \
        }                                                                                                                           \
                                                                                                                                    \
    } while (0)
...
#define cmc_assert_not_in_range_uint64_t(lower_bound, upper_bound, actual)                                                          \
    ...
    {                                                                                                                               \
        ...
        if (actual >= lower_bound && actual <= upper_bound)                                                                         \
        {                                                                                                                           \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected Range: [%" PRIu64 ", %" PRIu64 "] Actual: %" PRIu64 "\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);                                         \
        }                                                                                                                           \
                                                                                                                                    \
    } while (0)
...
#define cmc_assert_not_in_range_intmax_t(lower_bound, upper_bound, actual)                                                             \
    ...
    {                                                                                                                                  \
        ...
        if (actual >= lower_bound && actual <= upper_bound)                                                                            \
        {                                                                                                                              \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected Range: [%" PRIdMAX ", %" PRIdMAX "] Actual: %" PRIdMAX "\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);                                            \
        }                                                                                                                              \
                                                                                                                                       \
    } while (0)
...
#define cmc_assert_not_in_range_uintmax_t(lower_bound, upper_bound, actual)                                                            \
    ...
    {                                                                                                                                  \
        ...
        if (actual >= lower_bound && actual <= upper_bound)                                                                            \
        {                                                                                                                              \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected Range: [%" PRIuMAX ", %" PRIuMAX "] Actual: %" PRIuMAX "\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);                                            \
        }                                                                                                                              \
                                                                                                                                       \
    } while (0)
...
#define cmc_assert_not_in_range_float(lower_bound, upper_bound, actual)                                  \
    ...
    {                                                                                                    \
        ...
        if (actual >= lower_bound && actual <= upper_bound)                                              \
        {                                                                                                \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected Range: [%f, %f] Actual: %f\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);              \
        }                                                                                                \
                                                                                                         \
    } while (0)
...
#define cmc_assert_not_in_range_double(lower_bound, upper_bound, actual)                                    \
    ...
    {                                                                                                       \
        ...
        if (actual >= lower_bound && actual <= upper_bound)                                                 \
        {                                                                                                   \
            printf("Assertion Failed at %s:%s:%u for { %s }: Not Expected Range: [%lf, %lf] Actual: %lf\n", \
                   __FILE__, __func__, __LINE__, str, lower_bound_, upper_bound_, actual_);                 \
        }                                                                                                   \
                                                                                                            \
    } while (0)
