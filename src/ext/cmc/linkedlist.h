 ...
 * ITER
 */
#define CMC_EXT_CMC_LINKEDLIST_ITER(PARAMS)    \
    CMC_EXT_CMC_LINKEDLIST_ITER_HEADER(PARAMS) \
    CMC_EXT_CMC_LINKEDLIST_ITER_SOURCE(PARAMS)

#define CMC_EXT_CMC_LINKEDLIST_ITER_HEADER(PARAMS) \
    CMC_EXT_CMC_LINKEDLIST_ITER_HEADER_(           \
        CMC_PARAM_PFX(PARAMS), CMC_PARAM_SNAME(PARAMS), CMC_PARAM_V(PARAMS))

#define CMC_EXT_CMC_LINKEDLIST_ITER_SOURCE(PARAMS) \
    CMC_EXT_CMC_LINKEDLIST_ITER_SOURCE_(           \
        CMC_PARAM_PFX(PARAMS), CMC_PARAM_SNAME(PARAMS), CMC_PARAM_V(PARAMS))
 ...
 * NODE
 */
#define CMC_EXT_CMC_LINKEDLIST_NODE(PARAMS)    \
    CMC_EXT_CMC_LINKEDLIST_NODE_HEADER(PARAMS) \
    CMC_EXT_CMC_LINKEDLIST_NODE_SOURCE(PARAMS)

#define CMC_EXT_CMC_LINKEDLIST_NODE_HEADER(PARAMS) \
    CMC_EXT_CMC_LINKEDLIST_NODE_HEADER_(           \
        CMC_PARAM_PFX(PARAMS), CMC_PARAM_SNAME(PARAMS), CMC_PARAM_V(PARAMS))

#define CMC_EXT_CMC_LINKEDLIST_NODE_SOURCE(PARAMS) \
    CMC_EXT_CMC_LINKEDLIST_NODE_SOURCE_(           \
        CMC_PARAM_PFX(PARAMS), CMC_PARAM_SNAME(PARAMS), CMC_PARAM_V(PARAMS))
 ...
 * STR
 */
#define CMC_EXT_CMC_LINKEDLIST_STR(PARAMS)    \
    CMC_EXT_CMC_LINKEDLIST_STR_HEADER(PARAMS) \
    CMC_EXT_CMC_LINKEDLIST_STR_SOURCE(PARAMS)

#define CMC_EXT_CMC_LINKEDLIST_STR_HEADER(PARAMS) \
    CMC_EXT_CMC_LINKEDLIST_STR_HEADER_(           \
        CMC_PARAM_PFX(PARAMS), CMC_PARAM_SNAME(PARAMS), CMC_PARAM_V(PARAMS))

#define CMC_EXT_CMC_LINKEDLIST_STR_SOURCE(PARAMS) \
    CMC_EXT_CMC_LINKEDLIST_STR_SOURCE_(           \
        CMC_PARAM_PFX(PARAMS), CMC_PARAM_SNAME(PARAMS), CMC_PARAM_V(PARAMS))
...
#define CMC_EXT_CMC_LINKEDLIST_STR_SOURCE_(PFX, SNAME, V)               \
    ...
    {                                                                   \
        ...
        return 0 <= fprintf(fptr,                                       \
                            ...
                            "alloc:%p, "                                \
                            "callbacks:%p }",                           \
                            CMC_TO_STRING(SNAME), CMC_TO_STRING(V), l_, \
                            l_->count, l_->head, l_->tail, l_->flag,    \
