 ...
 * ITER
 */
#define CMC_EXT_CMC_INTERVALHEAP_ITER(PARAMS)    \
    CMC_EXT_CMC_INTERVALHEAP_ITER_HEADER(PARAMS) \
    CMC_EXT_CMC_INTERVALHEAP_ITER_SOURCE(PARAMS)

#define CMC_EXT_CMC_INTERVALHEAP_ITER_HEADER(PARAMS) \
    CMC_EXT_CMC_INTERVALHEAP_ITER_HEADER_(           \
        CMC_PARAM_PFX(PARAMS), CMC_PARAM_SNAME(PARAMS), CMC_PARAM_V(PARAMS))

#define CMC_EXT_CMC_INTERVALHEAP_ITER_SOURCE(PARAMS) \
    CMC_EXT_CMC_INTERVALHEAP_ITER_SOURCE_(           \
        CMC_PARAM_PFX(PARAMS), CMC_PARAM_SNAME(PARAMS), CMC_PARAM_V(PARAMS))
 ...
 * STR
 */
#define CMC_EXT_CMC_INTERVALHEAP_STR(PARAMS)    \
    CMC_EXT_CMC_INTERVALHEAP_STR_HEADER(PARAMS) \
    CMC_EXT_CMC_INTERVALHEAP_STR_SOURCE(PARAMS)

#define CMC_EXT_CMC_INTERVALHEAP_STR_HEADER(PARAMS) \
    CMC_EXT_CMC_INTERVALHEAP_STR_HEADER_(           \
        CMC_PARAM_PFX(PARAMS), CMC_PARAM_SNAME(PARAMS), CMC_PARAM_V(PARAMS))

#define CMC_EXT_CMC_INTERVALHEAP_STR_SOURCE(PARAMS) \
    CMC_EXT_CMC_INTERVALHEAP_STR_SOURCE_(           \
        CMC_PARAM_PFX(PARAMS), CMC_PARAM_SNAME(PARAMS), CMC_PARAM_V(PARAMS))
