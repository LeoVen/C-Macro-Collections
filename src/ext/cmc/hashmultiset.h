 ...
 * ITER
 */
#define CMC_EXT_CMC_HASHMULTISET_ITER(PARAMS)    \
    CMC_EXT_CMC_HASHMULTISET_ITER_HEADER(PARAMS) \
    CMC_EXT_CMC_HASHMULTISET_ITER_SOURCE(PARAMS)

#define CMC_EXT_CMC_HASHMULTISET_ITER_HEADER(PARAMS) \
    CMC_EXT_CMC_HASHMULTISET_ITER_HEADER_(           \
        CMC_PARAM_PFX(PARAMS), CMC_PARAM_SNAME(PARAMS), CMC_PARAM_V(PARAMS))

#define CMC_EXT_CMC_HASHMULTISET_ITER_SOURCE(PARAMS) \
...
#define CMC_EXT_CMC_HASHMULTISET_STR_HEADER(PARAMS) \
    CMC_EXT_CMC_HASHMULTISET_STR_HEADER_(           \
        CMC_PARAM_PFX(PARAMS), CMC_PARAM_SNAME(PARAMS), CMC_PARAM_V(PARAMS))

#define CMC_EXT_CMC_HASHMULTISET_STR_SOURCE(PARAMS) \
