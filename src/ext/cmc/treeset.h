 ...
 * SETF
 */
#define CMC_EXT_CMC_TREESET_SETF(PARAMS) \
    CMC_EXT_CMC_TREESET_SETF_HEADER(PARAMS) \
    CMC_EXT_CMC_TREESET_SETF_SOURCE(PARAMS)

#define CMC_EXT_CMC_TREESET_SETF_HEADER(PARAMS) \
    CMC_EXT_CMC_TREESET_SETF_HEADER_(CMC_PARAM_PFX(PARAMS), CMC_PARAM_SNAME(PARAMS), CMC_PARAM_V(PARAMS))

#define CMC_EXT_CMC_TREESET_SETF_SOURCE(PARAMS) \
