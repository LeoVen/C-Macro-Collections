...
#define CMC_EXT_CMC_LIST_SEQ_HEADER(PARAMS)             \
    CMC_EXT_CMC_LIST_SEQ_HEADER_(CMC_PARAM_PFX(PARAMS), \
                                 CMC_PARAM_SNAME(PARAMS), CMC_PARAM_V(PARAMS))

#define CMC_EXT_CMC_LIST_SEQ_SOURCE(PARAMS)             \
    CMC_EXT_CMC_LIST_SEQ_SOURCE_(CMC_PARAM_PFX(PARAMS), \
                                 CMC_PARAM_SNAME(PARAMS), CMC_PARAM_V(PARAMS))
...
#define CMC_EXT_CMC_LIST_STR_HEADER(PARAMS)             \
    CMC_EXT_CMC_LIST_STR_HEADER_(CMC_PARAM_PFX(PARAMS), \
                                 CMC_PARAM_SNAME(PARAMS), CMC_PARAM_V(PARAMS))

#define CMC_EXT_CMC_LIST_STR_SOURCE(PARAMS)             \
    CMC_EXT_CMC_LIST_STR_SOURCE_(CMC_PARAM_PFX(PARAMS), \
                                 CMC_PARAM_SNAME(PARAMS), CMC_PARAM_V(PARAMS))
...
#define CMC_EXT_CMC_LIST_STR_SOURCE_(PFX, SNAME, V)                        \
    ...
    {                                                                      \
        ...
        return 0 <= fprintf(fptr,                                          \
                            ...
                            l_->buffer, l_->capacity, l_->count, l_->flag, \
